...
const CardItem = ({ pokemon }: Pokemon) => {
  ...
  return (
    <>
      ...
      <ModalElement open={openModal} setOpen={setOpenModal} character={pokemon} name={pokemonName} image={front_default}/>
    </>
  )
}
